...
public final class ErosionBukkit extends JavaPlugin {
    public static final Map<Player, BukkitPacketHandler> ACTIVE_PLAYERS = new Object2ObjectOpenHashMap<>();
    ...
    public void onEnable() {
        ...
        listener.createServer("/tmp/geyser.sock", new BukkitPacketHandler(getLogger()));
